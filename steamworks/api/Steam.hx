...
class Steam
{
	...
	public static function init(appId_:Int, notificationPosition:SteamNotificationPosition = SteamNotificationPosition.BottomRight) {
		...
		try {
			SteamWrap_ClearAchievement = cpp.Lib.load("steamworks", "SteamWrap_ClearAchievement", 1);
			SteamWrap_DownloadScores = cpp.Lib.load("steamworks", "SteamWrap_DownloadScores", 3);
			SteamWrap_FindLeaderboard = cpp.Lib.load("steamworks", "SteamWrap_FindLeaderboard", 1);
			SteamWrap_GetCurrentGameLanguage = cpp.Lib.load("steamworks", "SteamWrap_GetCurrentGameLanguage", 0);
			SteamWrap_GetGlobalStat = cpp.Lib.load("steamworks", "SteamWrap_GetGlobalStat", 1);
			SteamWrap_GetStat = cpp.Lib.load("steamworks", "SteamWrap_GetStat", 1);
			SteamWrap_GetStatFloat = cpp.Lib.load("steamworks", "SteamWrap_GetStatFloat", 1);
			SteamWrap_GetStatInt = cpp.Lib.load("steamworks", "SteamWrap_GetStatInt", 1);
			SteamWrap_IndicateAchievementProgress = cpp.Lib.load("steamworks", "SteamWrap_IndicateAchievementProgress", 3);
			SteamWrap_Init = cpp.Lib.load("steamworks", "SteamWrap_Init", 2);
			SteamWrap_IsSteamRunning = cpp.Lib.load("steamworks", "SteamWrap_IsSteamRunning", 0);
			SteamWrap_RequestStats = cpp.Lib.load("steamworks", "SteamWrap_RequestStats", 0);
			SteamWrap_RunCallbacks = cpp.Lib.load("steamworks", "SteamWrap_RunCallbacks", 0);
			SteamWrap_SetAchievement = cpp.Lib.load("steamworks", "SteamWrap_SetAchievement", 1);
			SteamWrap_GetAchievement = cpp.Lib.load("steamworks", "SteamWrap_GetAchievement", 1);
			SteamWrap_GetAchievementDisplayAttribute = cpp.Lib.load("steamworks", "SteamWrap_GetAchievementDisplayAttribute", 2);
			SteamWrap_GetNumAchievements = cpp.Lib.load("steamworks", "SteamWrap_GetNumAchievements", 0);
			SteamWrap_GetAchievementName = cpp.Lib.load("steamworks", "SteamWrap_GetAchievementName", 1);
			SteamWrap_SetStat = cpp.Lib.load("steamworks", "SteamWrap_SetStat", 2);
			SteamWrap_SetStatFloat = cpp.Lib.load("steamworks", "SteamWrap_SetStatFloat", 2);
			SteamWrap_SetStatInt = cpp.Lib.load("steamworks", "SteamWrap_SetStatInt", 2);
			SteamWrap_Shutdown = cpp.Lib.load("steamworks", "SteamWrap_Shutdown", 0);
			SteamWrap_StoreStats = cpp.Lib.load("steamworks", "SteamWrap_StoreStats", 0);
			SteamWrap_UploadScore = cpp.Lib.load("steamworks", "SteamWrap_UploadScore", 3);
			SteamWrap_RequestGlobalStats = cpp.Lib.load("steamworks", "SteamWrap_RequestGlobalStats", 0);
			SteamWrap_RestartAppIfNecessary = cpp.Lib.load("steamworks", "SteamWrap_RestartAppIfNecessary", 1);
			SteamWrap_OpenOverlay = cpp.Lib.load("steamworks", "SteamWrap_OpenOverlay", 1);
		}
		catch (e:Dynamic) {
